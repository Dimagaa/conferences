...
<div class="row d-flex justify-content-center align-items-center">
    <div class="card col-10 mt-5" style="border-radius: 2rem">
        <div class="card-body">
            <form action="${pageContext.request.contextPath}/events/change?action=save"
                    ...
                    <div class="col-md">
                        <ul class="list-group" id="reports">
                            <c:forEach var="report" items="${requestScope.reports}">
                                <li id="report_${report.id}"
                                    class="list-group-item list-group-item-action d-flex justify-content-between align-items-start">
                                    <div class="ms-2 me-auto w-100"  onclick="changeReportModalShow(this, '#changeReport', ${report.id})">
                                        <div class="fw-bold rep-topic">
                                                ${report.topic}
                                        </div>
                                        <div class="rep-speaker" value="${report.speakerId}">
                                            <span class="rep-speaker-name">${report.speakerName}
                                            <span class="rep-speaker-email fst-italic text-black-50">${report.speakerEmail}</span>
                                        </div>
                                    </div>
                                    <div class="">
                                        <button type="button" class="btn-close" aria-label="Delete"
                                                onclick="deleteReport(${report.id})"></button>
                                    </div>
                                </li>
                            </c:forEach>
                        </ul>
                ...
                <div class="row mb-4">
                    <div class="col-md d-flex justify-content-center align-items-center">
                        ...
                        <div class="ms-3">
                            <input type="hidden" name="status" value="${requestScope.event.status}">
                            <input type="hidden" name="redirectPath" value="${pageContext.request.getHeader("referer")}">
            ...
            <!-- Insert Report Modal -->
            <div class="modal fade" id="insertReport" tabindex="-1" aria-labelledby="addReportModal" aria-hidden="true">
