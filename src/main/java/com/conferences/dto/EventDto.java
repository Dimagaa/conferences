...
public class EventDto implements Serializable {
    ...
    private boolean hasProposedReport;
    ...
    public boolean hasProposedReport() {
        return hasProposedReport;
    }

    public void hasProposedReport(boolean hasProposedReport) {
        this.hasProposedReport = hasProposedReport;
    }
